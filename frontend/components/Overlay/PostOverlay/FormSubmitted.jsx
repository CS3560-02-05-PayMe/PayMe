	...
	return (
		<div className={clsx("d-flex flex-column w-100 h-100", styles.formSubmitted)}>
			...
			<div className="d-flex flex-column w-100 mt-2 justify-content-center align-items-center">
				<svg id="checkmark" className={clsx("checkmark d-flex text-center m-auto", styles.formCheckmark)} xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 32 32">
					<circle className="circle" cx="16" cy="16" r="16" fill="#00b32d" />
					<path className="check" d="M9 16l5 5 9-9" fill="none" stroke="#fff" stroke-width="2.5" stroke-linecap="round" />
				</svg>
				<div className="my-4">
